"""
Aviation Compliance API - Azure Simplified Version
API simples para compliance da família E-Jets da Embraer
Versão com dados em memória para deploy rápido no Azure
"""
...
app = FastAPI(
    ...
    description="API completa para compliance da família E-Jets da Embraer",
    version="3.0.0",
    contact={
...
# Base de dados completa da família E-Jets Embraer em memória
EMBRAER_AIRCRAFT_DB = {
    # E1 Series (Original)
    "E170": {
        "model": "E170",
...
async def health_check():
    ...
    return {
        ...
        "aircraft_models_loaded": len(EMBRAER_AIRCRAFT_DB)
    }

@app.get("/aircraft/models", response_model=Dict[str, Any])
async def get_aircraft_models():
    """Lista todos os modelos de aeronaves"""
...
async def check_compliance(model: str, authority: str, check_type: str = Query("full")) -> ComplianceResponse:
    ...
    # Calcular compliance score (E2 series gets bonus)
    ...
    details = {
        ...
        "authority_region": REGULATORY_AUTHORITIES[authority_upper]["region"]
    }
