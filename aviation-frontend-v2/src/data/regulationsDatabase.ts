...
export interface Regulation {
    ...
    category: 'CERTIFICATION' | 'OPERATION' | 'MAINTENANCE' | 'SAFETY' | 'ENVIRONMENTAL' | 'SECURITY';
...
export const regulations: Regulation[] = [
    // FAA Regulations
    {
        ...
        description: 'Estabelece padrões de aeronavegabilidade para aviões de categoria de transporte',
        authority: 'FAA',
        ...
        verificationMethod: 'Testes de certificação, análise estrutural, voos de teste',
    ...
    },
    {
        ...
        description: 'Padrões de aeronavegabilidade para aviões de categoria normal',
        authority: 'FAA',
        category: 'CERTIFICATION',
        severity: 'CRITICAL',
    ...
    },
    {
        ...
        description: 'Sistemas de gerenciamento de segurança para provedores de serviços',
        authority: 'FAA',
        category: 'SAFETY',
        severity: 'MAJOR',
    ...
    },
    {
        id: 'easa-cs-23',
        reference: 'CS-23',
        title: 'Certification Specifications for Normal, Utility, Aerobatic, and Commuter Category Aeroplanes',
        description: 'Especificações para aeronaves de categorias normal e utilitária',
        authority: 'EASA',
        category: 'CERTIFICATION',
        severity: 'CRITICAL',
        applicableTo: ['EXECUTIVE', 'AGRICULTURAL'],
    ...
    },
    {
        ...
        description: 'Requisitos para sistemas de comunicação, navegação e vigilância',
        authority: 'EASA',
        category: 'SAFETY',
        severity: 'MAJOR',
        applicableTo: ['COMMERCIAL', 'EXECUTIVE'],
    ...
    },
    {
        id: 'anac-rbac-121',
        reference: 'RBAC 121',
        title: 'Requisitos Operacionais: Operações Domésticas, de Bandeira e Suplementares',
 ...
 */
export function getRegulationsByAuthority(authority: 'FAA' | 'EASA' | 'ANAC'): Regulation[] {
