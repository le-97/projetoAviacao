...
function Test-AzureCLI {
    ...
    try {
        ...
        Write-Error "Azure CLI não está instalado. Instale de: https://docs.microsoft.com/en-us/cli/azure/install-azure-cli"
        exit 1
    }
}
...
function Test-AzureLogin {
    ...
    try {
        ...
        Write-Warning "Não logado no Azure. Fazendo login..."
        az login
...
function New-ContainerRegistry {
    ...
    if (-not $registryExists) {
        ...
        Write-Warning "Container Registry já existe"
    }
}
...
function New-ContainerAppsEnvironment {
    ...
    if (-not $envExists) {
        ...
        Write-Warning "Container Apps Environment já existe"
    }
}
...
function Get-DeploymentInfo {
    Write-Info "Obtendo informações do deployment..."
    ...
    Write-Success "🌐 URLs da aplicação:"
...
function Test-Deployment {
    ...
    try {
        ...
        # Testar métricas
        Write-Info "Testando endpoint de métricas..."
        ...
        # Testar documentação
        Write-Info "Testando documentação..."
...
function Deploy-ToAzure {
    ...
    Write-Success "🎯 Aplicação disponível em: $appUrl"
}
