...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 disabled:cursor-not-allowed [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-95",
  {
    variants: {
      variant: {
        default: "bg-aviation-600 text-white hover:bg-aviation-700 shadow-aviation",
        destructive: "bg-red-600 text-white hover:bg-red-700 shadow-lg",
        outline: "border-2 border-aviation-300 bg-transparent text-aviation-700 hover:bg-aviation-50 hover:border-aviation-400",
        secondary: "bg-gray-100 text-gray-900 hover:bg-gray-200",
        ghost: "text-aviation-700 hover:bg-aviation-50 hover:text-aviation-800",
        link: "text-aviation-600 underline-offset-4 hover:underline hover:text-aviation-700",
        ...
        aviation: "aviation-gradient text-white hover:opacity-90 shadow-aviation-lg",
      },
      size: {
